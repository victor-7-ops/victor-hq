...
import { Map as MapIcon, LayoutGrid, List, X, MessageSquare, User, Orbit } from "lucide-react"
...
type View = "map" | "grid" | "feed" | "constellation"
                  ...
                  >
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          {selected.model.includes("/") ? selected.model.split("/").pop() : selected.model}
                        </div>
                        {selected.model.includes("/") && (
                          ...
                          >
                            {selected.model.split("/").slice(0, -1).join("/")}
                          </div>
                        )}
                      </div>
                    </div>

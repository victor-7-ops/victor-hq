...
interface SettingsContextValue {
  ...
  setOperatorProfileImage: (image: string | null) => void
...
const SettingsContext = createContext<SettingsContextValue>({
  settings: { accentColor: null, portalName: null, portalSubtitle: null, portalEmoji: null, portalIcon: null, iconBgHidden: false, emojiOnly: false, operatorName: null, operatorProfileImage: null, agentOverrides: {}, liveStreamPosition: null },
  setAccentColor: () => {},
  setPortalName: () => {},
  setPortalSubtitle: () => {},
  setPortalEmoji: () => {},
...
export function SettingsProvider({ children }: { children: React.ReactNode }) {
  ...
  const setOperatorProfileImage = useCallback(
    (image: string | null) => {
      update({ ...settings, operatorProfileImage: image })
    },
    [settings, update],
  )

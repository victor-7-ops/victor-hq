...
function DeliveryBadge({ cron }: { cron: CronJob }) {
  ...
  const color = isDelivered ? "var(--system-green)" : isUnknown ? "var(--accent-energy)" : "var(--accent-energy)";
...
export default function CronsPage() {
  ...
  return (
    <div className="h-full flex flex-col animate-fade-in" style={{ background: "var(--bg)" }}>
      {/* ── Sticky header ──────────────────────────────────────── */}

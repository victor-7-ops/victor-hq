// Settings types + localStorage helpers for OpenClaw Dashboard
...
export interface ClawPortSettings {
  ...
  operatorProfileImage: string | null // base64 data URL for operator photo
...
export function loadSettings(): ClawPortSettings {
  ...
  try {
    ...
    return {
      ...
      operatorProfileImage: typeof parsed.operatorProfileImage === 'string' ? parsed.operatorProfileImage : null,
      agentOverrides:

...
export function OfficeCanvas({ officeState, onClick, onSelectionChange, onHover, isEditMode, editorState, onEditorTileAction, onEditorEraseAction, onEditorSelectionChange, onDeleteSelected, onRotateSelected, onDragMove, editorTick: _editorTick, zoom, onZoomChange, panRef }: OfficeCanvasProps) {
  ...
  const handleMouseMove = useCallback(
    (e: React.MouseEvent) => {
      ...
      onHover?.(hitId, e.clientX, e.clientY)
    },
    [officeState, screenToWorld, screenToTile, isEditMode, editorState, onEditorTileAction, onEditorEraseAction, panRef, hitTestDeleteButton, hitTestRotateButton, clampPan, onHover],
  )
  ...
  const handleMouseLeave = useCallback(() => {
    ...
    onHover?.(null, 0, 0)
  }, [officeState, editorState, onHover])

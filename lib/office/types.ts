...
/** Source rectangle within an atlas/tileset image */
export interface TilesetRef {
  /** Source X in the tileset (pixels) */
  sx: number
  /** Source Y in the tileset (pixels) */
  sy: number
  /** Source width (pixels) */
  sw: number
...
export interface FurnitureInstance {
  ...
  zY: number
  /** Optional tileset region for atlas-based rendering (Donarg) */
...
export interface Character {
  ...
  folderName?: string
  /** MetroCity appearance (assigned on spawn) */
  metroCityAppearance?: {
    skinTone: number
    hairStyle: number

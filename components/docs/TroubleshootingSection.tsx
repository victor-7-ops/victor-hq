...
export function TroubleshootingSection() {
  return (
    <>
      ...
      <Paragraph>
        Common issues and their solutions when running OpenClaw Dashboard.
      </Paragraph>
  ...
  "http": {
    "endpoints": {
      ...
      <Paragraph>
        ...
        <InlineCode>.env.local</InlineCode> so OpenClaw Dashboard connects to the right port.
      </Paragraph>
      ...
      <NumberedList
        items={[
          ...
          <>
            ...
            -- OpenClaw Dashboard logs errors to the terminal where{" "}
      ...
      <Paragraph>
        ...
        <InlineCode>"agents/vera/SOUL.md"</InlineCode>, OpenClaw Dashboard will look for{" "}
        <InlineCode>
      ...
      <NumberedList
        items={[
          ...
          <>
            ...
            -- OpenClaw Dashboard resizes to 1200px max, but extremely large images may

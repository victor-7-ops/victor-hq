        ...
        <Table
          ...
          rows={[
            [
              ...
              <><strong key="j">Atlas</strong> -- the root node. reportsTo: null.</>,
            ],
            [
              "Team Lead",
  ...
  +-- SCRIBE (Memory Architect)-- standalone`}
      ...
      <NumberedList
        items={[
          ...
          <>
            <strong>Max depth of 3.</strong> Atlas to Robin to TRACE is
...
Where its persistent knowledge lives.`}
      ...
      <Callout type="note">
        ...
        each agent's <InlineCode>soulPath</InlineCode> field. OpenClaw Dashboard reads
      ...
      <Table
        ...
        rows={[
          ...
          [
            ...
            "Run shell commands",
            "Orchestrator + leads who run pipelines (Atlas, LUMEN, HERALD)",
          ],
          [
...
// Atlas -- orchestrator with full access
...
- Always include Z in output`}
  ...
  content-calendar.md   -- MAVEN's editorial calendar`}
      ...
      <Table
        ...
        rows={[
          ...
          [
            ...
            "Daily",
            "Check flight prices, message Atlas if deal found under threshold",
          ],
          [
            "Memory compression",
      ...
      <BulletList
        items={[
          <>
            <strong>Give voices to conversational agents.</strong> Atlas
      ...
      <InfoCard title="5. Depth of 3, max">
        <Paragraph>
          Atlas to Robin to TRACE is three levels. Going deeper adds latency

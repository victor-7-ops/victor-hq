...
export function ComponentsSection() {
  return (
    <>
      ...
      <Paragraph>
        OpenClaw Dashboard's component tree follows the standard Next.js App Router
    ...
    SettingsProvider (app/settings-provider.tsx)
      ...
      <Table
        ...
        rows={[
          [
            "OnboardingWizard",
            "10-step first-run setup wizard (welcome, prerequisites, workspace, gateway, agents, features, appearance, notifications, integrations, tour). Re-runnable from Settings.",
          ],
          [
            "AgentAvatar",

...
export function GettingStartedSection() {
  return (
    <>
      ...
      <Paragraph>
        This guide walks you through getting OpenClaw Dashboard running against your own
        OpenClaw instance. OpenClaw Dashboard is a Next.js 16 dashboard for managing,
      ...
      <BulletList
        items={[
          ...
          <>
            ...
            -- OpenClaw Dashboard talks to the gateway at{" "}
...
npm run dev`}
      ...
      <Paragraph>
        OpenClaw Dashboard expects the OpenClaw gateway running at{" "}
      ...
      <Paragraph>
        On your first visit, OpenClaw Dashboard launches the onboarding wizard (10 steps):
      </Paragraph>
      <NumberedList
        items={[
          "Welcome -- product overview and feature highlights",
          "Prerequisites -- auto-detect Node.js, OpenClaw CLI, workspace, and gateway token",
          "Workspace Setup -- configure your OpenClaw data directory",
          "Gateway Connection -- test connectivity to the OpenClaw gateway",
          "Agent Discovery -- scan workspace and display discovered agents",
          "Feature Selection -- toggle which modules to enable",
          "Appearance -- set your name, dashboard name, subtitle, and accent color",
          "Notifications -- cost alerts, security alerts, and key rotation reminders",
          "Integrations -- optional GitHub repository and PAT configuration",
          "Tour & Summary -- feature overview and quick-start tips",
        ]}
      />
      <Paragraph>

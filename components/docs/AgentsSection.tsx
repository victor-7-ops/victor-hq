...
export function AgentsSection() {
  return (
    <>
      ...
      <Paragraph>
        OpenClaw Dashboard automatically discovers your agents from your OpenClaw
        workspace. No configuration is needed -- if you have agents in your
        workspace, OpenClaw Dashboard will find and display them.
      </Paragraph>

      <SubHeading>Auto-Discovery (Default)</SubHeading>
      <Paragraph>
        OpenClaw Dashboard scans <InlineCode>$WORKSPACE_PATH/agents/</InlineCode> for
      ...
      <Paragraph>
        OpenClaw Dashboard checks for this file on every request. If it exists, it
